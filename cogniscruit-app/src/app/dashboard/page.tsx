...
import { FaFileAlt, FaLinkedin, FaGlobe, FaGithub, FaBriefcase, FaCheck, FaTimes, FaEdit, FaTrash } from "react-icons/fa";
...
export default function Dashboard() {
    ...
    const fetchUserJobs = async () => {
      try {
        ...
        const jobs = data.jobs.map((job: any) => ({
          ...
          questions: job.behavioural === 'Not Processed' ? [] : [job.behavioural]
        }));
        setRecentJobs(jobs);
      } catch (error) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : 'An error occurred while generating questions');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Recent Jobs</h3>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full p-6">
                    ...
                    <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <p className="text-gray-800 dark:text-gray-200 whitespace-pre-wrap">
                        {recentJobs.find(job => job.id === selectedJob)?.title}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Behavioral Questions</h3>
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Technical Questions</h3>
                        <div className="space-y-3">
                          {[
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Questions Generated</h3>
                <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">0</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Job Descriptions Analyzed</h3>
                <p className="text-3xl font-bold text-green-600 dark:text-green-400">0</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Average Question Quality</h3>
